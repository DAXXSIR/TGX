   ...
   if update_channel:
      try:
         ...
         if user.status == "kicked":
            await app.send_message(chat_id=message.chat.id,text="Sorry Sir, You are Banned. Contact My [Support Group](https://t.me/DevilsHaveli).", parse_mode="markdown", disable_web_page_preview=True)
            return 1
